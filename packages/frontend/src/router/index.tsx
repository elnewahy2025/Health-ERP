...
export const appRoutes: AppRoute[] = [
  ...
  { path: '/departments', label: 'Departments', labelKey: 'nav.departments', icon: 'Building2' },
  { path: '/emergency-access', label: 'Emergency Access', labelKey: 'nav.emergencyAccess', icon: 'ShieldAlert' },
...
export const routePermissions: Record<string, string> = {
  ...
  '/emergency-access': 'emergency_access.manage',
  '/crm': 'crm.view',
  '/dms': 'documents.view',
  ...
  '/pharmacy-advanced': 'pharmacy.view',
  '/insurance-claims-lifecycle': 'insurance_claims.view',
  ...
  '/notification-logs': 'notifications.manage',
